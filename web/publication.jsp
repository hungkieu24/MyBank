                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-9 mil-p-50-80">
                            ...
                            <ul class="mil-pup-tags mil-mb-80 mil-up">
                                ...
                                <li><a href="#.">digital finance</a></li>
                                <li><a href="#.">transaction flexibility</a></li>
                            </ul>
                            ...
                            <ul class="mil-comments mil-mb-80">
                                <li>
                                    <div class="mil-comment mil-up">
                                        <div class="mil-avatar"><img src="img/faces/1.jpg" alt="user"></div>
                                        <div class="mil-comment-text">
                                            ...
                                            <a href="#." class="mil-reply">Reply</a>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="mil-comment mil-up">
                                        <div class="mil-avatar"><img src="img/faces/2.jpg" alt="user"></div>
                                        <div class="mil-comment-text">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="mil-comment mil-up">
                                                <div class="mil-avatar"><img src="img/faces/3.jpg" alt="user"></div>
                                                <div class="mil-comment-text">
                                ...
                                <li>
                                    <div class="mil-comment mil-up">
                                        <div class="mil-avatar"><img src="img/faces/4.png" alt="user"></div>
                                        <div class="mil-comment-text">
                                ...
                                <li>
                                    <div class="mil-comment mil-up">
                                        <div class="mil-avatar"><img src="img/faces/5.png" alt="user"></div>
                                        <div class="mil-comment-text">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="mil-comment mil-up">
                                                <div class="mil-avatar"><img src="img/faces/6.png" alt="user"></div>
                                                <div class="mil-comment-text">
